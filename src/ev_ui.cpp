...
namespace ev_ui{
  ...
  void main_ui(){
    ...
    static float f = 0.0f; //Proof of concept, we don't want to keep state here in static vars
    ...
    ImGui::Checkbox("Daniel Window", &show_another_window);      // Edit bools storing our window open/close state
